...
read -p "Press [ENTER] when neither the police or the acquired disk is attached to the device."
sleep 5
...
clear
echo -e $basic
echo -e "Please attach the $underline police $ec disk to the device."
...
clear
echo -e $basic
echo -e "Please attach the $underline acquired $ec disk to the device."
...
clear
echo -e $basic
echo -e "Now, these are the devices:"
echo -e "The police HDD is: $green $policehdd $ec"
echo " "
echo -e "The acquired HDD is: $green $acquiredhdd $ec"
echo " "
...
echo -e "The imaging was successful, please remove the $green acquired disk $ec."
